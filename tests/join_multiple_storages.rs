...
async fn join_multiple_storages() {
    ...
    test(
        ...
        json!([{
            "type": "SELECT",
            "rows": [
                { "mid": 10, "lid": 20, "sid": 30 },
                { "mid": 10, "lid": 20, "sid": 31 },
                { "mid": 10, "lid": 21, "sid": 30 },
                { "mid": 10, "lid": 21, "sid": 31 },
                { "mid": 11, "lid": 20, "sid": 30 },
                { "mid": 11, "lid": 20, "sid": 31 },
                { "mid": 11, "lid": 21, "sid": 30 },
                { "mid": 11, "lid": 21, "sid": 31 }
            ]
        }]),
    )
    .await;
